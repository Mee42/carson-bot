...
public class BoardForTac {
	...
	public BoardForTac(int a0,int a1, int a2,int a3,int a4,int a5,int a6,int a7,int a8) {
	...
	public BoardForTac copy() {
		return new BoardForTac(board[0],board[1],board[2],board[3],board[4],board[5],board[6],board[7],board[8]);
	}
